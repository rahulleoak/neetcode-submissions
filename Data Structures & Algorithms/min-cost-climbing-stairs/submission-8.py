...
At the i-th step, we want to know the MIN cost it takes to reach here in addition to the cost[i].
...
class Solution:
    def minCostClimbingStairs(self, cost: List[int]) -> int:
        ...
        for i in range(2, n):
            costToReach = cost[i] + min(takeOne, takeTwo)

            takeTwo, takeOne = takeOne, costToReach
